...
**7× Critical · 7× High · 16× Medium · 10× Low** — 40 disclosures across 30 protocols and 7 platforms.

| Severity | Platform | Protocol / Class |
|----------|----------|------------------|
| Critical | Immunefi | Vaults / asset management |
| Critical | Immunefi | Omnichain messaging |
| Critical | Immunefi | Bitcoin / Lightning payments |
| Critical | Immunefi | Bitcoin / Lightning payments |
| Critical | Immunefi | Layer 2 / scaling |
| Critical | Code4rena | Glow Finance |
| Critical | Code4rena | Rujira |
| High | Immunefi | Beanstalk |
| High | Cantina | Lending AMM |
| High | Self-hosted | Layer 1 (non-EVM) |
| High | Immunefi | Layer 1 (Cosmos-SDK) |
| High | Immunefi | Layer 1 (Cosmos-SDK) |
| High | HackenProof | Layer 1 (Move) |
| High | HackenProof | DEX aggregator |
| Medium | Immunefi | Layer 1 (Cosmos-SDK) |
| Medium | Immunefi | Layer 1 (Cosmos-SDK) |
| Medium | Immunefi | Liquid staking |
| Medium | Cantina | Wallet infrastructure |
| Medium | Immunefi | Metaverse / NFT platform |
| Medium | Immunefi | Oracle network |
| Medium | Immunefi | Cross-chain messaging |
| Medium | HackenProof | Cross-chain intents |
| Medium | Immunefi | Lido |
| Medium | Immunefi | Beanstalk |
| Medium | Sherlock | Liquid restaking |
| Medium | HackenProof | Layer 1 (gaming-focused) |
| Medium | Code4rena | Rujira |
| Medium | Immunefi | Serai |
| Medium | HackenProof | Dexlyn |
| Medium | HackenProof | Cross-chain bridge |
| Low | Cantina | Wallet infrastructure |
| Low | Immunefi | Bitcoin staking |
| Low | HackenProof | Modular DA layer |
| Low | Sherlock | Tokenized RWA |
| Low | HackerOne | Layer 1 (non-EVM) |
| Low | Code4rena | Glow Finance |
| Low | Code4rena | Glow Finance |
| Low | Code4rena | Intuition |
| Low | Code4rena | Rujira |
| Low | Immunefi | Serai |
...
- [AtomWallet ERC-4337 userOp.callData Prefixing Breaks EntryPoint Execution (AA DoS)](https://github.com/code-423n4/intuition-bug-bounty/issues/34) — **Intuition** · Low
